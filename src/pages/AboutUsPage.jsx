                ...
                <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {platforms.map((platform) => (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="gradient-card elevate-card block p-6 transition-all duration-300 hover:-translate-y-1"
                    >
                      <div className="mb-5 rounded-2xl border border-gray-200 bg-white px-4 py-5">
                      ...
                      <h3 className="text-xl font-semibold text-slate-950">{platform.title}</h3>
              ...
              <div className="saas-shell section-layer p-8">
                ...
                <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                  {values.map((value, index) => (
                    <article
                      key={value.title}
                      className={`${index === 0 || index === 3 ? "feature-tile" : "gradient-card"} elevate-card p-6`}
                    >
