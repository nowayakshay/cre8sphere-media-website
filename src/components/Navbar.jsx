...
function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 pt-5">
      <PageContainer>
        <div
          className={`mx-auto rounded-[999px] border border-slate-200 bg-white px-7 py-1.5 transition-all duration-300 ${
            scrolled
              ? "shadow-[0_12px_26px_-12px_rgba(15,23,42,0.16)]"
              : "shadow-[0_6px_16px_-10px_rgba(15,23,42,0.12)]"
          }`}
        >
          <div className="flex h-[62px] items-center justify-between sm:h-[64px]">
            {/* Logo: Far left on desktop, left on mobile */}
              ...
              <ul className="flex h-full items-center gap-7">
                {primaryLinks.slice(0, 2).map((link) => (
                  <li key={link.label} className="h-full">
                    <Link
                      to={link.to}
                      className={`relative inline-flex h-full items-center px-1 text-[12px] font-semibold tracking-wide transition-colors duration-200 ${
                        isActive(link.to)
                          ? "text-teal-600"
                ...
                >
                  <button
                    ...
                    className={`inline-flex h-full items-center gap-1 text-[12px] font-semibold tracking-wide transition-colors duration-200 ${
                      isPlatformsOpen
                        ? "text-teal-600"
                        : "text-slate-600 hover:text-slate-900"
                    }`}
                              ...
                              {group.items.map((item) =>
                                ...
                                >
                                  ...
                                  <a
                                    ...
                                    className="group flex min-h-[44px] items-center justify-between rounded-[28px] px-3 text-sm font-medium text-slate-700 transition-all duration-200 hover:bg-teal-50 hover:text-teal-700 hover:translate-x-1"
                                  >
            ...
            {/* Desktop: Primary Button on Right / Mobile: Hamburger on Right */}
            <div className="flex items-center gap-4">
              <div className="hidden flex-shrink-0 md:flex">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex items-center gap-2 rounded-[999px] bg-[#008080] px-5 py-2 text-[12px] font-bold text-white shadow-[0_8px_16px_rgba(15,23,42,0.12)] transition-all duration-300 hover:scale-[1.02] hover:bg-[#0a6d6d]"
                >
                  Visit GizmoGeek Hub
            ...
            <div className="max-h-[75vh] overflow-y-auto border-t border-slate-100 px-1 pb-6 pt-4">
              <div className="space-y-1.5">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setIsOpen(false)}
                  className="mt-6 inline-flex h-12 w-full items-center justify-center gap-2 rounded-[28px] bg-[#008080] px-6 text-[13px] font-bold text-white shadow-lg shadow-teal-900/10 transition-all duration-300 hover:bg-[#0a6d6d] active:scale-[0.98]"
                >
                  Visit GizmoGeek Hub
