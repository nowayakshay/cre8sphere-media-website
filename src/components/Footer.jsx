        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-5 lg:gap-8">
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-2.5 text-xs font-medium text-slate-600">
              ...
              <Link to="/solutions" className="transition-colors hover:text-[#008080]">Solutions</Link>
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-2.5 text-xs font-medium text-slate-600">
              ...
              <a href="https://origin8agency.in/" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-[#008080]">Origin8 Agency</a>
              <a href="https://repurplex.com" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-[#008080]">Repurplex AI</a>
            </div>
          </div>
